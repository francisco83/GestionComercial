...
class Auth extends CI_Controller
{
	...
	*/
	...
	/*Se agrega para grupos*/ 
	/***********************************************/
	public function view_group(){
		$this->load->view("auth/view_group");
	}

	public function get_all(){
		$resultado = $this->ion_auth->listar();
		echo $resultado;
	}
	...
	{	
		...
		$data = array(
			"groups" => $this->ion_auth->buscar($buscar,$inicio,$cantidad),
			"totalregistros" => count($this->ion_auth->buscar($buscar)),
			"cantidad" =>$cantidad
	...
	function get_autocomplete(){
        if (isset($_GET['term'])) {
            $result = $this->ion_auth->search_autocomplete($_GET['term']);
            if (count($result) > 0) {
	...
	public function ajax_add()
	{
		...
		$insert = $this->ion_auth->save($data);
		echo json_encode(array("status" => TRUE));
	}

	public function ajax_edit($id)
	{
		$data = $this->ion_auth->get_by_id($id);
		echo json_encode($data);
	}
	...
	public function ajax_update()
	{
		...
		$this->ion_auth->update_(array('id' => $this->input->post('id')), $data);
		echo json_encode(array("status" => TRUE));
	}
	...
	{	
		$this->ion_auth->delete_by_id($id);
		echo json_encode(array("status" => TRUE));
	}

	public function ajax_enabled($id)
	{		
		$this->ion_auth->enabled_by_id($id);
		echo json_encode(array("status" => TRUE));
	}
	...
	public function createXLS() {
       ...
       $empInfo = $this->ion_auth->get_all_export();

    ...
    <div class="panel-heading">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input class="form-control" name="codigo" required type="text" id="codigo" placeholder="Escribe el codigo">
			</div> 
		...
		<div class="panel-footer">
			...
			<a href="<?php echo base_url() ?>index.php/clientesz" class="btn btn-info"> Volver Atrás</a>
		</div>

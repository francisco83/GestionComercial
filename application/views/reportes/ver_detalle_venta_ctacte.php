        ...
        <table style="border=0" width="100%"> 
            ...
            <tbody> 
					...
					<table class="table table-bordered" style="font-size: smaller; width:30%">
                                <tbody>
                                    <tr>
                                        <td class="padding0"><strong>#</strong></td>
										<td class="padding0"><strong>Fecha Pago</strong></td>
                                        <td class="padding0"><strong>Moneda</strong></td>
										<td class="padding0"><strong>Monto</strong></td>
                                    </tr>    
									<?php $i=1; $suma=0;?>     									                                           

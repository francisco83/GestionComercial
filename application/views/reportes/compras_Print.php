<body cz-shortcut-listen="true">
        <table width="100%"> 
            ...
            <tbody> 
                    <tr> 
                        <td width="100%"> 
						<div class="titulo_reporte">Reporte de Compras (<?php echo date('d/m/Y', strtotime($_GET['fecha_desde']))." - ".date('d/m/Y', strtotime($_GET['fecha_hasta'])).")"; ?></div>
                            <table class="table table-bordered" style="font-size: smaller">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="padding0"><strong>Total Compra</strong></td>    

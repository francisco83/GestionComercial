			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
                        <h4>Tipos de Cocheras</h4>
                        <a class="pull-right btn btn-primary" style="margin-top: -30px" href="<?php echo site_url()?>reportes/tipos_cocheras" target="_blank"><i class="glyphicon glyphicon-print"></i></a>					
						<a class="pull-right btn btn-primary" style="margin-top: -30px" href="<?php echo site_url()?>/tipos_cocheras/createxls"><i class="glyphicon glyphicon-floppy-save"></i></a>					
					</div>
...
function mostrarDatos(valorBuscar,pagina,cantidad){
	...
	$.ajax({
		...
		success:function(response){			
			filas = "";
			$.each(response.tipos_cocheras,function(key,item){
...
function add()
{
    ...
    $('.modal-title').text('Agregar Tipo de Cochera');
...
function edit(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('#modal_form').modal('show');
            $('.modal-title').text('Editar Tipos de cocheras');
			$('.modal-backdrop').remove();
        },
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Tipo de Cocheras</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
					...
					<div class="panel-body">
						...
						<div class="form-group">
                            <label for="comentario" class="col-sm-2">comentario:</label>
                            <div class="col-sm-10">
							    <input class="form-control" id="comentario" name="comentario" placeholder="Ingrese la descripción" class="form-control">
                                <span class="help-block"></span>
                            </div>   
						</div>
					</div>

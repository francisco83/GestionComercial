			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
                        ...
                        <a class="pull-right btn btn-primary" style="margin-top: -30px" href="<?php echo site_url()?>reportes/tipos_monedas" target="_blank"><i class="glyphicon glyphicon-print"></i></a>					
						<a class="pull-right btn btn-primary" style="margin-top: -30px" href="<?php echo site_url()?>/tipos_monedas/createxls"><i class="glyphicon glyphicon-floppy-save"></i></a>					
					</div>
...
function mostrarDatos(valorBuscar,pagina,cantidad){
	...
	$.ajax({
		...
		success:function(response){			
			filas = "";
			$.each(response.tipos_monedas,function(key,item){
...
function add()
{
    ...
    $('.modal-title').text('Agregar Tipo de Moneda');
...
function edit(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('#modal_form').modal('show');
            $('.modal-title').text('Editar Tipo de Moneda');
			$('.modal-backdrop').remove();
        },
